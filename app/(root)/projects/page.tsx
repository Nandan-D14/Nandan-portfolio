  ...
  const data = [
    {
      ...
      content: (
        <div>
          ...
          <div className="h-20 w-full rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] md:h-44 lg:h-60">
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-8 text-xl font-normal text-neutral-800 md:text-neutral-200">
            A real-time hand gesture and distance-sensor-based mouse, scroll,
            and volume controller using Python, OpenCV, MediaPipe, and Arduino.
            This hybrid system enables touchless control of PC functions via
            hand gestures and ultrasonic sensor inputs.
          </p>
          <p className="mb-8 text-xl font-normal text-neutral-800 md:text-neutral-200">
            check live here{" "}
            <a
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              🔄 IR Sensor toggle: Lock/Unlock cursor or enable/disable
              controls.
            </div>
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              🔊 Text-to-Speech – Natural voice responses with customizable
              voice settings.
            </div>
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-8 text-xl font-normal text-neutral-800 md:text-neutral-200">
            This is a Python-based weather application with a graphical
            interface built using Tkinter. It provides real-time weather
            updates, a 7-day forecast, air quality details (AQI, PM2.5, PM10),
            and timezone info. The app supports both text and voice input, and
            gives spoken weather reports using text-to-speech.
          </p>
          <p className="mb-8 text-xl font-normal text-neutral-800 md:text-neutral-200">
            check live here{" "}
            <a
      ...
      content: (
        <div>
          <p className="mb-8 text-xl font-normal text-neutral-800 md:text-neutral-200">
            ...
            provides a sleek, glassy search interface for quick access to
            multiple search engines and custom websites
          </p>
          <p className="mb-8 text-xl font-normal text-neutral-800 md:text-neutral-200">
            check live here{" "}
            <a
